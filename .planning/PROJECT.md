...
- ✓ Free-carry items (Backpack, Bag of Coins, Thieves Tools) excluded from GearSlotsUsed; shown in separate "Free Carry" section (GEAR-01) — v1.2; MAUI IsFreeCarry round-trip fixed (Validated in Phase 7: maui-isfreecarry-fix)
